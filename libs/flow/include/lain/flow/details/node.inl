...
namespace lain::flow
{
	...
	{
		m_inputs.push_back(Port(std::move(name), Port::Direction::Input, std::type_index(typeid(T)), lain::meta::typeName<T>()));
	...
	{
		m_outputs.push_back(Port(std::move(name), Port::Direction::Output, std::type_index(typeid(T)), lain::meta::typeName<T>()));
